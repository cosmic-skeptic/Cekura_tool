...
with st.sidebar:
    ...
    rbi_call_hours = st.text_input(
        "Permitted calling hours (RBI)", "8 AM-7 PM",
        help="Used by callback-time cards. Leave blank if not applicable.")
